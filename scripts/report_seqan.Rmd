...
\begin{center}
\large \it \bf
 `r min(global_logdata$date)` to `r max(global_logdata$date)`
\end{center}
...
ggplot(plot_data_long, aes(x=date, y=calls)) +
  ...
  scale_x_date(limits = c(as.Date("2020-04-01"), NA), oob = scales::oob_keep, date_labels = "%b %Y", minor_breaks = "1 months", date_breaks = "6 months") +
