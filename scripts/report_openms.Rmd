...
ggplot(cit,aes(x=year,y=cites))+
  ...
  scale_x_continuous(breaks=2006:2025,
                     labels=c("2006","2007","2008","2009","2010","2011","2012","2013","2014","2015","2016","2017","2018","2019","2020","2021","2022","2023","2024","2025"))+
  theme_bw()+
...
ggplot(plot_data_long, aes(x=date, y=calls)) +
  ...
  scale_x_date(limits = c(as.Date("2019-11-01"), NA), oob = scales::oob_keep, date_labels = "%b %Y", minor_breaks = "1 months", date_breaks = "6 months") +
